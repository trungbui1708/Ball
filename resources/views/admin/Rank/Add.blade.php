					...
					@endif
                                        ...
                                        <div class="form-group">
                                            <label class="">Chọn giải đấu</label>
                                                ...
                                                <label class="">Chọn vòng đấu</label>
                                                <select class="form-control fix-option" name="round">
                                                    @foreach($round as $key)
                                                    <option value="{{$key->id}}">{{$key->round_number}}</option>
                                                    @endforeach
                                                </select>
                                        </div>
                                            	<label>Vòng đấu</label>
                                                <input placeholder="Nhập " name="round_number" type="text" class="form-control" >
