					...
					@endif
                                        ...
                                        <div class="form-group">
                                            <label class="">Chọn thể loại</label>
                                                ...
                                                <label>Mô tả</label>
                                                <input style="height: 150px;" value="{{$news->description}}" placeholder="Nhập mô tả" name="description" type="text" class="form-control" >
                                                <label>Nội dung</label>
                                                <textarea class="ckeditor fix-ckeditor" id="editor" value="{{$news->content}}"  name="content"  ></textarea>
