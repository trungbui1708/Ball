<div class="side-nav expand-lg">
                <div class="side-nav-inner">
                  ...
                  <!--       <div class="fix-menu " >
                        ...
                        <li class="nav-item dropdown">
                            <a href="admin/round/list" class="dropdown-toggle" href="javascript:void(0);">
                                <span class="icon-holder">
									<i class="mdi mdi-vector-arrange-above"></i>
								</span>
                                <span class="title">Vòng đấu</span>
                                <span class="arrow">
									<i class="mdi mdi-chevron-right"></i>
								</span>
                            </a>
                        ...
                        <li class="nav-item dropdown">
                            <a href="admin/image/list" class="dropdown-toggle" href="javascript:void(0);">
                                <span class="icon-holder">
