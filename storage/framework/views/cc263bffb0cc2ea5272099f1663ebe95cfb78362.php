                                    ...
                                    <table id="dt-opt" class="table table-hover table-xl">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><img width="100px" height="100px" src="upload/news/<?php echo e($key->name); ?>"
                                                    <?php echo e($key -> name); ?>

                                                </td>
                                                <td><?php echo e($key -> news->tittle); ?></td>
                                                <td class="text-center font-size-18">
                                                    <a href="admin/image/add" class="text-gray m-r-15"><i class="ti-plus"></i></a>
