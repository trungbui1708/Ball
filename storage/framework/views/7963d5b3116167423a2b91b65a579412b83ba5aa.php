                                ...
                                <div class="latest-news-slider">
                                    ...
                                    <div> 
                                        <div class="news-normal-block">
                                            <div class="news-img">
                                                <a href="#">
                                                    <img src="upload/news/<?php echo e($post['name']); ?>" alt="" />
                                                </a>
                                            </div>
                                            <h4 class="news-title"><a href="news/<?php echo e($key->id); ?>"><?php echo e($key->tittle); ?></a></h4>
                                            <div class="news-desc">
                                                <p>
                                            ...
                                            <div class="news-btn">
                                                <a class="primary-btn" href="news/<?php echo e($key->id); ?>">Đọc tiếp</a>
                                            </div>
                                        </div>                             
                                        </div>
                                ...
                                <div class="latest-news-nav">
                                   <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                         ...
                                         ?>
                                    <div>
                                        <img src="<?php echo e(asset('upload/news/'.$post['name'])); ?>" alt="" />
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
