                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-12">
						...
						<div class="single-image">
							...
							<img src="<?php echo e(asset('upload/news/'.$img->name)); ?>"/>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                 
						</div>
						
						<p style="text-align: justify"><?php echo e($news->content); ?></p>
						...
						<div class="share-section">
							<div class="row">
								<div class="col-sm-6 col-xs-12 life-style">
									<span class="author"> 
										<a href="#"><i class="fa fa-user-o" aria-hidden="true"></i><?php echo e($news->author); ?></a>
									</span> 
									<span class="date">
										<i class="fa fa-calendar" aria-hidden="true"></i><?php echo e($news->created_at); ?>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="popular-post-img">
										<a href="#"><img src="<?php echo e(asset('index/images/blog-details/mid1.jpg')); ?>" alt="Blog single photo"></a>                                   
									</div>                                
									<h3>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="popular-post-img">
										<a href="#"><img src="<?php echo e(asset('index/images/blog-details/mid2.jpg')); ?>" alt="Blog single photo"></a>                     
									</div>                                
									<h3>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="popular-post-img">
										<a href="#"><img src="<?php echo e(asset('index/images/blog-details/mid3.jpg')); ?>" alt="Blog single photo"></a>                                  
									</div>                                
									<h3>
                    ...
                    <?php echo $__env->make('index.layout.right', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </div>
        </div>
